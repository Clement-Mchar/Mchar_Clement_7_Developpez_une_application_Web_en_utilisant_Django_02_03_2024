...
def create_review(request):
    ...
    form1 = TicketForm(request.POST if request.method == 'POST' else None, request.FILES if request.method =='POST' else None)
...
def flux(request):
    ...
    if followings:
        ...
        return render(request, 'app/flux.html', context={'posts':posts, 'followings':followings})
    else:
